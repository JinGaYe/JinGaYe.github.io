                            ...
                            botui.message
                                ...
                                .then(function() {
                                    botui.message
                                        .add({
                                            delay: 1500,
                                            content: "主攻 HTML/ CSS/ JavaScript ，偶尔也折腾Typescript/Nodejs",
                                        })
                                        .then(function() {
                                            botui.message
                                                .add({
                    ...
                    botui.message
                        ...
                        .then(function() {
                            botui.message
                                .add({
                                    delay: 1600,
                                    content: "也可以关注我的公众号![公众号](https://jarrychen.xyz/images/about/my_public.jpg) ~",
                                })
                                .then(function() {
                                    botui.message.add({
                                        delay: 1600,
                                        content: "或者加我个人微信![个人微信](https://jarrychen.xyz/images/about/my_wechat.jpg)，与我进行交流O(∩_∩)O哈！~",
                                    });
                                });
                        });
                });
